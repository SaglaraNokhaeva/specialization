...
Ссылка на созданный репозиторий -> [https://github.com/SaglaraNokhaeva/specialization][id1]
...
Ссылка на список коммитов -> [https://github.com/SaglaraNokhaeva/specialization/commits/main][id5]
